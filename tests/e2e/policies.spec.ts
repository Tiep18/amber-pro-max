...
import {createConfirmedUser, deleteUser, rest, signIn, type E2EUser} from './fixtures/authenticated-users';
...
test.describe('policy publishing (LEGAL-01, D-13, D-16)', () => {
  ...
  test('admin publishes bilingual policy pages and drafts stay private', async ({page}) => {
    ...
    const privacy = page.getByRole('region', {name: 'Privacy policy'}).first();
    ...
    await privacy.getByLabel('Vietnamese body').fill('Noi dung chinh sach rieng tu cho khach hang.');
