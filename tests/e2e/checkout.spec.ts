...
const resolvedServiceRoleKey = serviceRoleKey.includes('zdJsyH')
  ? serviceRoleKey
...
test('discount code applies and removes through server quote without localStorage trust', async ({
  page
}) => {
