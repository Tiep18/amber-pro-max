...
- [x] 06-04-PLAN.md - Add wishlist hearts to product cards and detail pages
...
- [x] 06-06-PLAN.md - Implement review moderation and one shop reply

**Wave 7** *(blocked on Wave 6 completion)*

- [x] 06-07-PLAN.md - Implement newsletter subscribe and consent history

**Wave 8** *(blocked on Wave 7 completion)*

- [x] 06-08-PLAN.md - Implement confirmation email and one-click unsubscribe

**Wave 9** *(blocked on Wave 8 completion)*

- [x] 06-09-PLAN.md - Implement read-only subscriber administration
...
- [x] 07-07: Complete admin dashboard and navigation
- [x] 07-09: Codify launch settings and fail-closed readiness gates
...
- [x] 08-01-PLAN.md - Add additive shipping schema, compatibility contracts, migration recovery rehearsal, and the blocking non-production push gate
...
- [x] 09-03-PLAN.md — Lock cart synchronization, cache isolation, and browser-test contracts (Wave 1)
- [x] 09-04-PLAN.md — Implement server market resolution, routing preservation, and context API (Wave 2)
- [x] 09-06-PLAN.md — Build private market-aware projections and commerce DTOs (Wave 2)
- [x] 09-05-PLAN.md — Implement the authoritative client storefront-context lifecycle (Wave 3)
- [x] 09-07-PLAN.md — Enforce product offer resolution and add-to-cart freshness gates (Wave 4)
- [x] 09-08-PLAN.md — Build reusable market-aware catalog list commerce (Wave 4)
- [x] 09-09-PLAN.md — Preserve static/ISR catalog rendering with client-side market projection (Wave 5)
- [x] 09-10-PLAN.md — Migrate category, collection, technique, and tag taxonomy surfaces (Wave 6)
- [x] 09-11-PLAN.md — Project homepage and wishlist commerce by active market (Wave 5)
- [x] 09-12-PLAN.md — Synchronize mixed carts through safe market changes and requotes (Wave 7)
...
- [x] 10-01-PLAN.md — Stabilize PDP/cart accessibility, quantity, subtotal, and remove/Undo behavior (Wave 1)
...
- [x] 10-03-PLAN.md — Build responsive checkout summary, field feedback, localized copy, and complete blocker presentation (Wave 3)

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 10-04-PLAN.md — Lock checkout submission and add centralized bilingual support and incident recovery (Wave 4)

**Wave 5** *(blocked on Wave 4 completion)*

- [x] 10-05-PLAN.md — Simplify payment-state hierarchy, terminal recovery, deadlines, cooldowns, and polling completion (Wave 5)

**Wave 6** *(blocked on Wave 5 completion)*

- [x] 10-06-PLAN.md — Add safe VietQR guidance/download and the verified-paid success experience (Wave 6)

**Wave 7** *(blocked on Wave 6 completion)*

- [x] 10-07-PLAN.md — Run full regression, security, responsive Playwright, CI, and manual UAT handoff (Wave 7)
