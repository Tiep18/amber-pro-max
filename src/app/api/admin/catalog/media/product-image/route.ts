...
import {uploadProductImageAction} from '@/catalog/media-actions';
import {MAX_PRODUCT_IMAGE_BYTES} from '@/catalog/media-schemas';

export const runtime = 'nodejs';
export const dynamic = 'force-dynamic';

const MAX_REQUEST_BYTES = MAX_PRODUCT_IMAGE_BYTES + 1024 * 1024;
