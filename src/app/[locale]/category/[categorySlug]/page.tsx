...
const copy = {
  ...
  vi: {
    eyebrow: 'Danh mục',
    count: 'sản phẩm',
    empty: 'Chưa có sản phẩm công khai trong danh mục này cho thị trường của bạn.',
    back: 'Quay lại cửa hàng',
    market: 'Hiện theo khả dụng của thị trường hiện tại'
  }
} as const;
...
export default async function CategoryPage({ params }: { params: Params }) {
  ...
  return (
    <main className="container grid gap-8 py-10 sm:py-12">
      <LocalizedRouteSlugs
        path={getCategoryPath(locale, category.slug)}
