      ...
      <div className="container relative py-12 lg:py-16">
        <div className="grid gap-10 lg:grid-cols-12 lg:gap-10 lg:items-start">
          ...
          <div className="max-w-md lg:col-span-4">
            ...
            <p className="mt-4 max-w-[32rem] text-pretty text-sm leading-7 text-[var(--muted-foreground)]">
              {copy.description}
            </p>
            <div className="mt-5 flex flex-wrap gap-x-4 gap-y-2 text-xs font-semibold text-[var(--accent)]">
          ...
          <nav className="grid grid-cols-2 gap-8 text-sm lg:col-span-4" aria-label={locale === 'vi' ? 'Liên kết footer' : 'Footer links'}>
            <div>
          ...
          <div className="flex flex-col gap-7 lg:col-span-4">
            ...
            />
            <div className="border-t border-[#c99e8b]/30 pt-5">
