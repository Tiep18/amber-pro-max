  ...
  return (
    <form action={toggle} className="relative inline-flex">
      ...
      <Toggle
        ...
        disabled={pending}
        className="min-h-11 min-w-11 rounded-full border border-white/70 bg-[var(--surface)]/78 px-0 shadow-sm backdrop-blur-sm transition duration-200 hover:-translate-y-px hover:bg-[var(--surface)] active:translate-y-0"
      >
        <Heart
          aria-hidden="true"
